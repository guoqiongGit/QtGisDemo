...
public:
    ...
    void setupUi(QWidget *QgsGpsDeviceWidgetBase)
    {
        ...
        gridLayout_3->addWidget(mButtonAddDevice, 1, 2, 1, 1);

        spacerItem = new QSpacerItem(31, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_3->addItem(spacerItem, 1, 1, 1, 1);
        ...
        gridLayout_3->addWidget(mButtonRemoveDevice, 1, 3, 1, 1);
        ...
        gridLayout_3->addWidget(mListDevices, 0, 1, 1, 3);
    ...
    void retranslateUi(QWidget *QgsGpsDeviceWidgetBase)
    {
        ...
        mButtonAddDevice->setToolTip(QCoreApplication::translate("QgsGpsDeviceWidgetBase", "Add new path", nullptr));
#endif // QT_CONFIG(tooltip)
        mButtonAddDevice->setText(QString());
#if QT_CONFIG(tooltip)
        mButtonRemoveDevice->setToolTip(QCoreApplication::translate("QgsGpsDeviceWidgetBase", "Remove path", nullptr));
#endif // QT_CONFIG(tooltip)
