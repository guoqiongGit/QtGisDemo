...
#if QT_CONFIG(tooltip)
        mStorageModeCbx->setToolTip(QCoreApplication::translate("QgsExternalResourceConfigDlg", "<html><head/><body><p>Allows to store file paths or directory paths</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
