...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        cb_userTablesOnly->setWhatsThis(QCoreApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>When searching for spatial tables restrict the search to tables that are owned by the user.</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        cb_useEstimatedMetadata->setToolTip(QCoreApplication::translate("QgsOracleNewConnectionBase", "Use estimated table statistics for the layer metadata.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        cb_useEstimatedMetadata->setWhatsThis(QCoreApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>When the layer is setup various metadata is required for the Oracle table. This includes information such as the table row count, geometry type and spatial extents of the data in the geometry column. If the table contains a large number of rows determining this metadata is time consuming.</p><p>By activating this option the following fast table metadata operations are done:</p><p>1) Row count is determined from all_tables.num_rows.</p><p>2) Table extents are always determined with the SDO_TUNE.EXTENTS_OF function even if a layer filter is applied.</p><p>3) The table geometry is determined from the first 100 non-null geometry rows in the table.</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
...
#if QT_CONFIG(tooltip)
        cb_geometryColumnsOnly->setToolTip(QCoreApplication::translate("QgsOracleNewConnectionBase", "Restrict the displayed tables to those that are in the all_sdo_geom_metadata table", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        cb_geometryColumnsOnly->setWhatsThis(QCoreApplication::translate("QgsOracleNewConnectionBase", "<html><head/><body><p>Restricts the displayed tables to those that are in the all_sdo_geom_metadata view. This can speed up the initial display of spatial tables.</p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
