...
public:
    ...
    void setupUi(QWidget *QgsLayoutLegendWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 367, 2191));
        ...
        mSymbolWidthSpinBox->setShowClearButton(false);
        ...
        mSymbolHeightSpinBox->setShowClearButton(false);
        ...
        mRasterStrokeWidthSpinBox->setShowClearButton(false);
        ...
        mWmsLegendWidthSpinBox->setShowClearButton(false);
        ...
        mWmsLegendHeightSpinBox->setShowClearButton(false);
        ...
        gridLayout_5->addWidget(label_121, 21, 0, 1, 1);
        ...
        gridLayout_5->addWidget(mLineSpacingSpinBox, 21, 1, 1, 1);
    ...
    void retranslateUi(QWidget *QgsLayoutLegendWidgetBase)
    {
        ...
        label_16->setText(QCoreApplication::translate("QgsLayoutLegendWidgetBase", "Font color", nullptr));
        ...
        label_121->setText(QCoreApplication::translate("QgsLayoutLegendWidgetBase", "Line space", nullptr));
        mLineSpacingSpinBox->setPrefix(QString());
        mLineSpacingSpinBox->setSuffix(QCoreApplication::translate("QgsLayoutLegendWidgetBase", " mm", nullptr));
    } // retranslateUi
