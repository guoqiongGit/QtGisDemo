...
public:
    ...
    void retranslateUi(QWidget *QgsRasterPyramidsOptionsWidgetBase)
    {
        ...
        cbxPyramidsFormat->setItemText(0, QCoreApplication::translate("QgsRasterPyramidsOptionsWidgetBase", "External (GTiff .ovr)", nullptr));
        cbxPyramidsFormat->setItemText(1, QCoreApplication::translate("QgsRasterPyramidsOptionsWidgetBase", "Internal (if possible)", nullptr));
        cbxPyramidsFormat->setItemText(2, QCoreApplication::translate("QgsRasterPyramidsOptionsWidgetBase", "External (Erdas Imagine .aux)", nullptr));
