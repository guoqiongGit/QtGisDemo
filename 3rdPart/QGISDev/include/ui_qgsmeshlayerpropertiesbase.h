...
public:
    ...
    void setupUi(QDialog *QgsMeshLayerPropertiesBase)
    {
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/themes/default/propertyicons/rendering.svg"), QSize(), QIcon::Normal, QIcon::Off);
        QListWidgetItem *__qlistwidgetitem3 = new QListWidgetItem(mOptionsListWidget);
        __qlistwidgetitem3->setIcon(icon3);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/themes/default/propertyicons/temporal.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 661, 508));
        ...
        mOptsPage_StyleContent->setGeometry(QRect(0, 0, 661, 508));
        ...
        mTemporalReloadButton->setIcon(icon6);
        ...
        QWidget::setTabOrder(mTemporalReloadButton, mTemporalDateTimeStart);
    ...
    void retranslateUi(QDialog *QgsMeshLayerPropertiesBase)
    {
        ...
        ___qlistwidgetitem3->setText(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Rendering", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem3->setToolTip(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Rendering", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem4 = mOptionsListWidget->item(4);
        ___qlistwidgetitem4->setText(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Temporal", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem4->setToolTip(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Temporal Settings", nullptr));
#endif // QT_CONFIG(tooltip)
        QListWidgetItem *___qlistwidgetitem5 = mOptionsListWidget->item(5);
        ___qlistwidgetitem5->setText(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Metadata", nullptr));
#if QT_CONFIG(tooltip)
        ___qlistwidgetitem5->setToolTip(QCoreApplication::translate("QgsMeshLayerPropertiesBase", "Metadata", nullptr));
#endif // QT_CONFIG(tooltip)
