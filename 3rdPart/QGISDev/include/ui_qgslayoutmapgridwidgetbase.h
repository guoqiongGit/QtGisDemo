...
public:
    ...
    void setupUi(QWidget *QgsLayoutMapGridWidgetBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 493, 1620));
...
#if QT_CONFIG(tooltip)
        mRotatedAnnotationsLengthModeComboBox->setToolTip(QCoreApplication::translate("QgsLayoutMapGridWidgetBase", "Determines how the ticks length is defined when rotated.", nullptr));
#endif // QT_CONFIG(tooltip)
        label_9->setText(QCoreApplication::translate("QgsLayoutMapGridWidgetBase", "Skip below angle", nullptr));
#if QT_CONFIG(tooltip)
        mRotatedAnnotationsThresholdSpinBox->setToolTip(QCoreApplication::translate("QgsLayoutMapGridWidgetBase", "Grid lines intersecting the border below this threshold will be ignored.", nullptr));
#endif // QT_CONFIG(tooltip)
