...
#if QT_CONFIG(tooltip)
        mCbxChainFilters->setToolTip(QCoreApplication::translate("QgsRelReferenceConfigDlgBase", "When activated, the filters will restrict the choices of fields to options that are ", nullptr));
#endif // QT_CONFIG(tooltip)
