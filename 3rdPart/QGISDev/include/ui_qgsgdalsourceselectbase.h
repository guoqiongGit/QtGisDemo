...
public:
    ...
    void setupUi(QDialog *QgsGdalSourceSelectBase)
    {
        ...
        mOpenOptionsGroupBox = new QgsCollapsibleGroupBox(QgsGdalSourceSelectBase);
        ...
        verticalLayout->addWidget(mOpenOptionsGroupBox);
    ...
    void retranslateUi(QDialog *QgsGdalSourceSelectBase)
    {
        ...
        label->setText(QCoreApplication::translate("QgsGdalSourceSelectBase", "Raster dataset(s)", nullptr));
        ...
        mAuthWarning->setText(QCoreApplication::translate("QgsGdalSourceSelectBase", "\342\200\246", nullptr));
        mAuthGroupBox->setTitle(QCoreApplication::translate("QgsGdalSourceSelectBase", "Authentication", nullptr));
        mOpenOptionsGroupBox->setTitle(QCoreApplication::translate("QgsGdalSourceSelectBase", "Options", nullptr));
