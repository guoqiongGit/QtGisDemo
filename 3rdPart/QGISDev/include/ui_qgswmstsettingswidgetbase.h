...
public:
    ...
    void retranslateUi(QWidget *QgsWmstSettingsWidgetBase)
    {
        ...
        mDisableTime->setToolTip(QCoreApplication::translate("QgsWmstSettingsWidgetBase", "If checked the time component of temporal queries will be discarded and only the data component will be used in server requests", nullptr));
