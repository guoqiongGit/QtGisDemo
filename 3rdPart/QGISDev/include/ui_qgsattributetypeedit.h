...
public:
    ...
    void setupUi(QWidget *QgsAttributeTypeDialog)
    {
        ...
        QgsAttributeTypeDialog->resize(752, 620);
        ...
        gridLayout->addWidget(reuseLastValuesCheckBox, 2, 1, 1, 1);
