...
public:
    ...
    QDoubleSpinBox *mDoubleSpinBoxMinWidth;
    ...
    QDoubleSpinBox *mDoubleSpinBoxMaxWidth;
    QLabel *label_6;
    QLabel *label_5;
    ...
    void setupUi(QWidget *QgsInterpolatedLineSymbolLayerWidgetBase)
    {
        ...
        mDoubleSpinBoxMinWidth = new QDoubleSpinBox(mVaryingWidthWidget);
        ...
        mDoubleSpinBoxMaxWidth = new QDoubleSpinBox(mVaryingWidthWidget);
