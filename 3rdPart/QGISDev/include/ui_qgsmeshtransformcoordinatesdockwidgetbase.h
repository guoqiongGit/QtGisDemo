...
public:
    ...
    void setupUi(QgsDockWidget *QgsMeshTransformCoordinatesDockWidgetBase)
    {
        ...
        QgsMeshTransformCoordinatesDockWidgetBase->resize(297, 182);
        ...
        gridLayout->addWidget(mExpressionEditX, 2, 1, 1, 1);
