...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 653, 679));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 653, 679));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 653, 679));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 653, 679));
        ...
        mMapTipExpressionFieldWidget->setObjectName(QString::fromUtf8("mMapTipExpressionFieldWidget"));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 689, 665));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 343, 800));
    ...
    void retranslateUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        groupBox_2->setTitle(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "HTML Map Tip", nullptr));
#if QT_CONFIG(tooltip)
        mInsertExpressionButton->setToolTip(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "Inserts the selected field or expression into the map tip", nullptr));
#endif // QT_CONFIG(tooltip)
        mInsertExpressionButton->setText(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "Insert", nullptr));
#if QT_CONFIG(tooltip)
        mMapTipExpressionFieldWidget->setToolTip(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "The valid attribute names for this layer", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        mRefreshLayerCheckBox->setText(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "Refresh layer at interval (seconds)", nullptr));
#if QT_CONFIG(tooltip)
        mRefreshLayerIntervalSpinBox->setToolTip(QCoreApplication::translate("QgsVectorLayerPropertiesBase", "Lower values result in more data refreshing. Canvas updates are deferred in order to avoid refreshing multiple times if more than one layer has an auto update interval set.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
