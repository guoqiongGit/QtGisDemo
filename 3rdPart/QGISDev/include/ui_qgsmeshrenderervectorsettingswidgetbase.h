...
public:
    ...
    void setupUi(QWidget *QgsMeshRendererVectorSettingsWidgetBase)
    {
        ...
        sizePolicy1.setHeightForWidth(mColorRampShaderMaximumSpinBox->sizePolicy().hasHeightForWidth());
        mColorRampShaderMaximumSpinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(mColorRampShaderMinimumSpinBox->sizePolicy().hasHeightForWidth());
        mColorRampShaderMinimumSpinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(mMaxMagSpinBox->sizePolicy().hasHeightForWidth());
        mMaxMagSpinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(mHeadLengthSpinBox->sizePolicy().hasHeightForWidth());
        mHeadLengthSpinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(mScaleShaftByFactorOfSpinBox->sizePolicy().hasHeightForWidth());
        mScaleShaftByFactorOfSpinBox->setSizePolicy(sizePolicy1);
