...
void DsgnRibbonPageTaskMenu::slotAddGroup()
{
    ...
    RibbonGroup* ribbonGroup = qobject_cast<RibbonGroup*>(fw->core()->widgetFactory()->createWidget(create_qtitan_className(QStringLiteral("RibbonGroup")), m_ribbonPage));
...
{
    if (iid == QStringLiteral("QDesignerInternalTaskMenuExtension"))
    {
