...
QWidget* DsgnRibbonPagePlugin::createWidget(QWidget* parent)
{
    ...
    result->setObjectName(QStringLiteral("__qt__passive_RibbonPage"));
...
{
    return create_qtitan_className(QStringLiteral("RibbonPage"));
}
...
{
    QString className = create_qtitan_className(QStringLiteral("RibbonPage"));
    return QStringLiteral("<ui language=\"c++\">\n"
        " <widget class=\"" "%1" "\" name=\"ribbonPage\"/>\n"
        " <customwidgets>\n"
        "   <customwidget>\n"
        "       <class>" "%2" "</class>\n"
