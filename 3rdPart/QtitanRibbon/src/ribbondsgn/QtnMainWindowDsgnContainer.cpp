...
MainWindowContainer::MainWindowContainer(RibbonMainWindow* widget, QObject* parent)
    ...
    , m_mainWindow(widget)
{
    widget->setObjectName(QStringLiteral("RibbonMainWindow"));
    widget->setWindowTitle(QStringLiteral("RibbonMainWindow"));
}
...
void MainWindowContainer::remove(int index)
{
    ...
    //else if (QLatin1String(widget->metaObject()->className()) == create_qtitan_className(QStringLiteral("RibbonStyle")))
    //{
