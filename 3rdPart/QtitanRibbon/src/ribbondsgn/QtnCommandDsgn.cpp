...
void CreateRibbonBarCommand::init(QMainWindow *mainWindow)
{
    ...
    m_ribbonBar = qobject_cast<QWidget*>(core->widgetFactory()->createWidget(create_qtitan_className(QStringLiteral("RibbonBar")), m_mainWindow));
...
void CreateRibbonBarCommand::redo()
{
    ...
    ((QWidget*)m_ribbonBar)->setObjectName(QStringLiteral("ribbonBar"));
...
void AddRibbonPageCommand::redo()
{
    ...
    m_ribbonPage->setObjectName(QStringLiteral("ribbonPage"));
...
{
    RibbonBar* pRibbonBar = mainWidget();
    m_ribbonPage = pRibbonBar->page(m_indexPage);
...
void AddRibbonGroupCommand::redo()
{
    ...
    m_ribbonGroup->setObjectName(QStringLiteral("ribbonGroup"));
