...
public:
    ...
    RibbonGroupPopupMenu* popupMenu();
protected:
...
private:
    ...
    RibbonGroupPopupMenu* m_popupMenu;
private:
    Q_DISABLE_COPY(RibbonGroupPopupButton)
};

class RibbonGroupPopupMenu : public QMenu
{
public:
    explicit RibbonGroupPopupMenu(RibbonGroup* group);
    virtual ~RibbonGroupPopupMenu();
public:
    virtual QSize sizeHint() const;
protected:
    virtual void paintEvent(QPaintEvent* event);
...
private:
    RibbonGroup* m_group;
private:
    Q_DISABLE_COPY(RibbonGroupPopupMenu)
};
