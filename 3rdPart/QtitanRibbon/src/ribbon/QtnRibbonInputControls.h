...
{
public:
    explicit RibbonFontComboBoxControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonLineEditControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonComboBoxControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonSpinBoxControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonDoubleSpinBoxControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonSliderControl(Qt::Orientation, RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonSliderPaneControl(RibbonGroup* parent = Q_NULL);
...
{
public:
    explicit RibbonDateTimeEditControl(RibbonGroup* parent = Q_NULL);
...
{
public:
    explicit RibbonTimeEditControl(RibbonGroup* parent = Q_NULL);
...
{
public:
    explicit RibbonDateEditControl(RibbonGroup* parent = Q_NULL);
