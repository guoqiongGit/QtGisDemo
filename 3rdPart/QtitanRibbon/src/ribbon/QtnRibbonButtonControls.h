...
class QTITAN_EXPORT RibbonButtonControl : public RibbonWidgetControl
{
    Q_OBJECT
public:
    explicit RibbonButtonControl(RibbonGroup* parent = Q_NULL);
...
{
public:
    explicit RibbonCheckBoxControl(const QString& text = QString(), RibbonGroup* parent = Q_NULL);
...
{
public:
    explicit RibbonRadioButtonControl(const QString& text = QString(), RibbonGroup* parent = Q_NULL);
