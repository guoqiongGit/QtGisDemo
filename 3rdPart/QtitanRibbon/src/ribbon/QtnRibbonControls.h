...
public:
    explicit RibbonControlSizeDefinition(RibbonControl* parent, GroupSize size);
...
class QTITAN_EXPORT RibbonControl : public QWidget
{
    Q_OBJECT
public:
    explicit RibbonControl(RibbonGroup* parent = Q_NULL);
...
class QTITAN_EXPORT RibbonWidgetControl : public RibbonControl
{
    Q_OBJECT
public:
    explicit RibbonWidgetControl(RibbonGroup* parent, bool ignoreActionSettings);
...
class QTITAN_EXPORT RibbonColumnBreakControl : public RibbonWidgetControl
{
    Q_OBJECT
public:
    explicit RibbonColumnBreakControl(RibbonGroup* parent = Q_NULL);
...
{
public: 
    explicit RibbonLabelControl(RibbonGroup* parent = Q_NULL);
    explicit RibbonLabelControl(const QString& text, RibbonGroup* parent = Q_NULL);
...
class QTITAN_EXPORT RibbonToolBarControl : public RibbonControl
{
    Q_OBJECT
public:
    explicit RibbonToolBarControl(RibbonGroup* parent = Q_NULL);
