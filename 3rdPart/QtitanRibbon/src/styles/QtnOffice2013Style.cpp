...
Office2013StylePrivate::Office2013StylePrivate()
    : m_themeType(Office2013Style::White)
{
}
...
void Office2013StylePrivate::initialization()
{
    QTN_P(OfficeStyle)
    QFont fontRibbon = p.font(Q_NULL);
    QApplication::setFont(fontRibbon, "QMenuBar");
    QApplication::setFont(fontRibbon, QTITAN_META_CLASSNAME("RibbonBar"));
}
...
void Office2013StylePrivate::initStandardPalette(QPalette& palette) const
{
    ...
    palette.setBrush(QPalette::Active, QPalette::Highlight, clrHighlight);
    palette.setBrush(QPalette::Inactive, QPalette::Highlight, clrHighlight);
    palette.setBrush(QPalette::Disabled, QPalette::Highlight, clrDisabledHighlight);
}
        ...
        if (const QStyleOptionGroupBox* optGroup = qstyleoption_cast<const QStyleOptionGroupBox*>(option))
        {
            ...
            else
            {
                ...
                if (optGroup->textAlignment == Qt::AlignBottom)
                {
                    ...
                    int indent = 0;
                    QPalette pal;
                    pal.setColor(QPalette::WindowText, clrRibbonSeparator.darker());
                    p.proxy()->drawItemText(painter, rect.adjusted(indent + 1, 1, -indent - 1, -1), Qt::AlignLeft | Qt::AlignVCenter | Qt::TextShowMnemonic, pal,
                ...
                else if (optGroup->textAlignment == Qt::AlignTop)
                {
                    ...
                    QPalette pal;
                    pal.setColor(QPalette::WindowText, clrRibbonSeparator.darker());
                    p.proxy()->drawItemText(painter, rect.adjusted(indent + rect.width() - rectText.width() - 2, 1, -indent - 1, -1), Qt::AlignLeft | Qt::AlignVCenter | Qt::TextShowMnemonic, pal,
                        optGroup->state & QStyle::State_Enabled, titleText, QPalette::WindowText);
                    painter->setPen(savePen);
                }
                else if (optGroup->textAlignment == Qt::AlignVCenter)
                {
                    ...
                    QPalette pal;
                    pal.setColor(QPalette::WindowText, clrRibbonSeparator.darker());
                    p.proxy()->drawItemText(painter, rect.adjusted(indent + (rect.width() - rectText.width()) / 2 - 2, 1, -indent - 1, -1), Qt::AlignLeft | Qt::AlignVCenter | Qt::TextShowMnemonic, pal,
                        optGroup->state & QStyle::State_Enabled, titleText, QPalette::WindowText);
                    painter->setPen(savePen);
                }
            }
    ...
    if (const QStyleOptionTabBarBase* tbb = qstyleoption_cast<const QStyleOptionTabBarBase *>(opt))
    {
        ...
        switch (tbb->shape)
        {
            ...
            case QTabBar::TriangularSouth:
                painter->restore();
                p.proxy()->drawPrimitive(QStyle::PE_FrameTabBarBase, opt, painter, widget);
                return true;
        }
        painter->restore();
        return true;
...
bool Office2013StylePrivate::drawFrameLineEdit(const QStyleOption* opt, QPainter* painter, const QWidget* w) const
{
    ...
    if (const QStyleOptionFrame* panel = qstyleoption_cast<const QStyleOptionFrame*>(opt))
    {
        ...
        drawRectDPI(*painter, panel->rect);
        painter->restore();
        return true;
    }
    return false;
...
bool Office2013StylePrivate::drawRibbonFileButton(const QStyleOptionComplex* opt, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const SystemToolButtonStyleOption* toolbutton = qstyleoption_cast<const SystemToolButtonStyleOption*>(opt))
    {
        ...
        if (toolbutton->toolButtonStyle != Qt::ToolButtonIconOnly)
        {
            ...
            pal.setBrush(QPalette::All, QPalette::ButtonText, isDarkColor(fillColor) ? Qt::white : Qt::black);
            p.proxy()->drawItemText(painter, toolbutton->rect, alignment, pal,
...
bool Office2013StylePrivate::drawRibbonTitleBarWidget(const QStyleOptionComplex* option, QPainter* painter, const QWidget* w) const
{
    ...
    if (const TitleBarStyleOption* optTitleBar = qstyleoption_cast<const TitleBarStyleOption*>(option))
    {
        ...
        for (QVector<TitleBarStyleOption::ContextData>::ConstIterator it = optTitleBar->listContextHeaders.begin(); it != optTitleBar->listContextHeaders.end(); ++it)
        {
            ...
            painter->setPen(StyleHelper::colorMakeDarker(colorContext.rgb(), 0.3));
...
bool Office2013StylePrivate::drawTitleBar(const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const QStyleOptionTitleBar* tb = qstyleoption_cast<const QStyleOptionTitleBar *>(option))
    {
        ...
        if (tb->subControls & QStyle::SC_TitleBarCloseButton && tb->titleBarFlags & Qt::WindowSystemMenuHint)
        {
            ...
            tool.palette.setColor(QPalette::Active, QPalette::Highlight, clrButton);
            ...
            tool.palette.setColor(QPalette::Active, QPalette::WindowText, clrText);
            tool.palette.setColor(QPalette::Inactive, QPalette::WindowText, clrText);
            tool.palette.setColor(QPalette::Active, QPalette::HighlightedText, clrHighlightedText.isValid() ? clrHighlightedText : clrText);
            tool.palette.setColor(QPalette::Inactive, QPalette::HighlightedText, clrHighlightedText.isValid() ? clrHighlightedText : clrText);
        ...
        if (tb->subControls & QStyle::SC_TitleBarMaxButton && tb->titleBarFlags & Qt::WindowMaximizeButtonHint && !(tb->titleBarState & Qt::WindowMaximized))
        {
            ...
            tool.palette.setColor(QPalette::Active, QPalette::WindowText, clrText);
            tool.palette.setColor(QPalette::Inactive, QPalette::WindowText, clrText);
            tool.palette.setColor(QPalette::Active, QPalette::HighlightedText, clrText);
            tool.palette.setColor(QPalette::Inactive, QPalette::HighlightedText, clrText);
        ...
        if (tb->subControls & QStyle::SC_TitleBarContextHelpButton && tb->titleBarFlags & Qt::WindowContextHelpButtonHint)
        {
            ...
            int margin = qRound(tool.rect.height() / marginRatio);
            tool.rect.adjust(margin, margin, -margin, -margin);
            tool.palette.setColor(QPalette::Active, QPalette::WindowText, Qt::black);
            tool.palette.setColor(QPalette::Active, QPalette::HighlightedText, Qt::black);
    ...
    if (const QStyleOptionSpinBox* sb = qstyleoption_cast<const QStyleOptionSpinBox *>(opt)) 
    {
        ...
        if (sb->frame && (sb->subControls & QStyle::SC_SpinBoxFrame)) 
        {
            if (sb->frame)
            {
                ...
                bool usePalette = false;
                uint resolve_mask = sb->palette.resolve();
                if (resolve_mask & (1 << QPalette::Base))
                    usePalette = true;
...
bool Office2013StylePrivate::drawRibbonTabShapeLabel(const QStyleOption* opt, QPainter* painter, const QWidget* w) const
{
    ...
    if (const RibbonOptionHeaderStyleOption* optTab = qstyleoption_cast<const RibbonOptionHeaderStyleOption*>(opt))
    {
        ...
        {
            textColor = CommonStyle::qtn_getColorToRGB(optTab->pageColor);
        ...
        p.proxy()->drawItemText(painter, optTab->rect, flags, pal, opt->state & QStyle::State_Enabled, text, QPalette::WindowText);
        return true;
    }
    return false;
}
...
bool Office2013StylePrivate::drawRibbonTab(const QStyleOption* opt, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const RibbonOptionHeaderStyleOption* optTab = qstyleoption_cast<const RibbonOptionHeaderStyleOption*>(opt))
    {
        ...
        if ((optTab->state & QStyle::State_Selected))
        {
            ...
            painter->setPen(colorContext.isValid() ? colorContext : optTab->palette.midlight().color());
            painter->drawPath(path);
            painter->setPen(savePen);
        }
        ...
        if (optTab->pageColor != Qtitan::ContextColorNone && !(optTab->state & QStyle::State_Selected))
        {
            ...
            if (!clrContextTab.isValid())
            {
                QColor color = CommonStyle::qtn_getColorToRGB(optTab->pageColor);
...
/*! \internal */
bool Office2013StylePrivate::drawRibbonTabBar(const QStyleOption* opt, QPainter* painter, const QWidget* w) const
{
    Q_UNUSED(w)
...
void Office2013StylePrivate::drawMenuItemSeparator(const QStyleOption* opt, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const QStyleOptionMenuItem* menuitem = qstyleoption_cast<const QStyleOptionMenuItem*>(opt))
    {
        ...
        else
        {
            ...
            painter->drawText(rectText, Qt::AlignVCenter | Qt::TextSingleLine, menuitem->text);
            painter->restore();
        }
    }
}
...
bool Office2013StylePrivate::drawMenuItem(const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const QStyleOptionMenuItem* menuitem = qstyleoption_cast<const QStyleOptionMenuItem*>(option))
    {
        ...
        if (activated)
        {
            ...
            drawRectDPI(*painter, menuitem->rect.adjusted(2, 1, -2, -1));
        }
...
//            drawSplitButtonPopup(p, menuitem->rect, activated, !disabled, menuitem->checkType == QStyleOptionMenuItem::Exclusive);
        ...
        if (!menuitem->icon.isNull())
        {
            ...
            if (checked)
            {
                ...
                QtnBrush brush(painter, colorFill);
                QtnPen pen(painter, colorBorder, 1);
                drawRectDPI(*painter, rcChecked.adjusted(-2, 0, 2, 0));
            }
...
bool Office2013StylePrivate::drawTabBarTabShape(const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const QStyleOptionTab* tab = qstyleoption_cast<const QStyleOptionTab *>(option)) 
    {
        ...
        const bool isPress = tab->state & QStyle::State_Sunken;
        const bool enabled = tab->state & QStyle::State_Enabled;
        const bool isHighlight = tab->state & QStyle::State_MouseOver;
        ...
        const bool firstTab = ((!rtlHorTabs && tab->position == QStyleOptionTab::Beginning) || (rtlHorTabs && tab->position == QStyleOptionTab::End));
        const bool onlyOne = tab->position == QStyleOptionTab::OnlyOneTab;
        const bool previousSelected = ((!rtlHorTabs && tab->selectedPosition == QStyleOptionTab::PreviousIsSelected) || (rtlHorTabs && tab->selectedPosition == QStyleOptionTab::NextIsSelected));
        const bool nextSelected = ((!rtlHorTabs && tab->selectedPosition == QStyleOptionTab::NextIsSelected) || (rtlHorTabs && tab->selectedPosition == QStyleOptionTab::PreviousIsSelected));
        const int tabBarAlignment = p.proxy()->styleHint(QStyle::SH_TabBar_Alignment, tab, widget);
        const bool leftAligned = (!rtlHorTabs && tabBarAlignment == Qt::AlignLeft) || (rtlHorTabs && tabBarAlignment == Qt::AlignRight);
        const bool rightAligned = (!rtlHorTabs && tabBarAlignment == Qt::AlignRight) || (rtlHorTabs && tabBarAlignment == Qt::AlignLeft);

        QColor light = tab->palette.light().color();
        QColor dark = tab->palette.dark().color();
        QColor shadow = tab->palette.shadow().color();
        int borderThinkness = p.proxy()->pixelMetric(QStyle::PM_TabBarBaseOverlap, tab, widget);
        if (selected)
            borderThinkness /= 2;
        ...
        QBrush fill = tab->palette.window();
        if (isPress && enabled)
            fill = buttonHighlightColor(tab->palette, true, false/*border*/);
        else if (isHighlight && enabled)
            fill = buttonHighlightColor(tab->palette, false, false/*border*/);
        ...
        switch (tab->shape) 
        {
            ...
            case QTabBar::RoundedNorth: 
            {
                ...
                painter->fillRect(QRect(x1 + 1, y1 + 1, (x2 - x1) - 1, (y2 - y1) - 2), fill);

                // Delete border
                if (selected) 
                {
                    painter->fillRect(QRect(x1, y2 - 1, x2 - x1, 1), tab->palette.window());
                    painter->fillRect(QRect(x1, y2, x2 - x1, 1), tab->palette.window());
                }
                // Left
            ...
            case QTabBar::RoundedSouth: 
            {
                ...
                painter->fillRect(QRect(x1 + 1, y1 + 2, (x2 - x1) - 1, (y2 - y1) - 1), fill);

                // Delete border
                if (selected) 
                {
                    painter->fillRect(QRect(x1, y1 + 1, (x2 - 1) - x1, 1), tab->palette.window());
                    painter->fillRect(QRect(x1, y1, (x2 - 1) - x1, 1), tab->palette.window());
                }
                // Left
                if (firstTab || selected || onlyOne || !previousSelected) 
                {
                ...
                {
                    painter->setPen(shadow);
                    painter->drawLine(x2, y2 - 2, x2, y1 + ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness));
                    painter->drawPoint(x2 - 1, y2 - 1);
                    painter->setPen(dark);
                    painter->drawLine(x2 - 1, y2 - 2, x2 - 1, y1 + ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness));
                }
                break; 
            }
            case QTabBar::RoundedWest: 
            {
                ...
                painter->fillRect(QRect(x1 + 1, y1 + 1, (x2 - x1) - 2, (y2 - y1) - 1), fill);

                // Delete border
                if (selected) {
                    painter->fillRect(QRect(x2 - 1, y1, 1, y2 - y1), tab->palette.window());
                    painter->fillRect(QRect(x2, y1, 1, y2 - y1), tab->palette.window());
                }
                // Top
                if (firstTab || selected || onlyOne || !previousSelected) {
                    painter->setPen(light);
                    painter->drawLine(x1 + 2, y1, x2 - ((onlyOne || firstTab) && selected && leftAligned ? 0 : borderThinkness), y1);
                    painter->drawPoint(x1 + 1, y1 + 1);
                }
                // Left
                {
                ...
                if (lastTab || selected || onlyOne || !nextSelected) {
                    painter->setPen(shadow);
                    painter->drawLine(x1 + 3, y2, x2 - ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness), y2);
                    painter->drawPoint(x1 + 2, y2 - 1);
                    painter->setPen(dark);
                    painter->drawLine(x1 + 3, y2 - 1, x2 - ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness), y2 - 1);
                    painter->drawPoint(x1 + 1, y2 - 1);
            ...
            case QTabBar::RoundedEast: 
            {
                ...
                painter->fillRect(QRect(x1 + 2, y1 + 1, (x2 - x1) - 1, (y2 - y1) - 1), fill);

                // Delete border
                if (selected) 
                {
                    painter->fillRect(QRect(x1 + 1, y1, 1, (y2 - 1) - y1), tab->palette.window());
                    painter->fillRect(QRect(x1, y1, 1, (y2 - 1) - y1), tab->palette.window());
                }
                // Top
                if (firstTab || selected || onlyOne || !previousSelected) 
                {
                    painter->setPen(light);
                    painter->drawLine(x2 - 2, y1, x1 + ((onlyOne || firstTab) && selected && leftAligned ? 0 : borderThinkness), y1);
                    painter->drawPoint(x2 - 1, y1 + 1);
                }
                // Right
                {
                ...
                {
                    painter->setPen(shadow);
                    painter->drawLine(x2 - 2, y2, x1 + ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness), y2);
                    painter->drawPoint(x2 - 1, y2 - 1);
                    painter->setPen(dark);
                    painter->drawLine(x2 - 2, y2 - 1, x1 + ((onlyOne || lastTab) && selected && rightAligned ? 0 : borderThinkness), y2 - 1);
                }
                break; 
            }
        }
...
bool Office2013StylePrivate::drawRibbonBar(const QStyleOption* opt, QPainter* painter, const QWidget* widget) const
{
    ...
    if (const RibbonStyleOption* optRibbon = qstyleoption_cast<const RibbonStyleOption*>(opt))
    {
        ...
        {
            options.palette.setBrush(QPalette::Active, QPalette::Window, Qt::white);
            options.palette.setBrush(QPalette::Inactive, QPalette::Window, Qt::white);
        }
...
/*! \internal */
bool Office2013StylePrivate::drawRibbonImageBackground(const QStyleOption* opt, QPainter* painter, const QWidget* w) const
{
    QTN_P(const Office2013Style)
    if (const RibbonBackgroundStyleOption* options = qstyleoption_cast<const RibbonBackgroundStyleOption*>(opt))
    {
        if (!options->pixTitleBackground.isNull())
        {
            ...
            if (p.theme() == Office2013Style::Dark)
            {
                ...
                painter->drawPixmap(rectDst, options->pixTitleBackground, rectSrc);
        }
        return true;
    }
    return false;
...
QColor Office2013StylePrivate::buttonHighlightColor(const QPalette& /*palette*/, bool highlightDn, bool border, const QWidget* widget) const
{
    ...
    if (border)
        return highlightDn ? StyleHelper::colorMakeLighter(p.accentColor().rgb(), 1.0) : StyleHelper::colorMakeLighter(p.accentColor().rgb(), 1.3);
...
{
    QTN_P(const Office2013Style);
    if (widget != Q_NULL && (QtnPrivate::qtn_isExistWindowTitleBar(widget) || widget->inherits("QMdiSubWindow")))
    {
        QPalette palette = pal;
        palette.setColor(isActive ? QPalette::Active : QPalette::Inactive, QPalette::Shadow, p.accentColor());
...
QPalette Office2013StylePrivate::getWidgetPalette(QWidget* widget) const
{
    ...
    else if (widget->inherits(QTITAN_META_CLASSNAME("StatusButton")) || (widget->parentWidget() && widget->parentWidget()->inherits("QStatusBar")))
    {
        ...
        else
        {
            ...
            pal.setBrush(QPalette::Active, QPalette::ButtonText, isRibbonStatusBarDark ? Qt::white : Qt::black);
            pal.setBrush(QPalette::Active, QPalette::Button, clrAccent);
