...
QRgb StyleHelper::lightColor(QRgb clr, int nTint)
{
    double h, s, l;
...
QRgb StyleHelper::darkColor(QRgb clr, int nShade)
{
    double h, s, l;
...
void StyleHelper::RGBtoHSL(QRgb clr, double& h, double& s, double& l)
{
...
QRgb StyleHelper::blendColors(QRgb crA, QRgb crB, double fAmountA)
{
...
QRgb StyleHelper::colorMakePale(const QRgb& clr, double lum)
{
    double h, s, l;
    StyleHelper::RGBtoHSL(clr, h, s, l);
    return StyleHelper::HLStoRGB_ONE(h, lum, s);
}

QRgb StyleHelper::colorMakeDarker(const QRgb& clr, double ratio)
{
    double h, s, l;
...
QRgb StyleHelper::colorMakeLighter(const QRgb& clr, double ratio)
{
    double h, s, l;
    double min = 0.01;
    StyleHelper::RGBtoHSL(clr, h, s, l);
