...
QT_MOC_LITERAL(3, 38, 9) // "userScale"
...
void QgsStatusBarScaleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QgsStatusBarScaleWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateScales(); break;
        case 1: _t->userScale(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject QgsStatusBarScaleWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_QgsStatusBarScaleWidget.data,
    qt_meta_data_QgsStatusBarScaleWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
