...
WhiteStyle::WhiteStyle(QStyle *style) : QProxyStyle(style)
{

}

QStyle *WhiteStyle::styleBase(QStyle *style) const {
  static QStyle *base =!style ? QStyleFactory::create(QStringLiteral("Fusion")) : style;
  return base;
}

QStyle *WhiteStyle::baseStyle() const { return styleBase(); }

void WhiteStyle::polish(QPalette &palette) {
   //modify palette to dark
  palette.setColor(QPalette::Window, QColor(246, 246, 246));
  palette.setColor(QPalette::WindowText, Qt::white);
  palette.setColor(QPalette::Disabled, QPalette::WindowText,
                   QColor(127, 127, 127));
  palette.setColor(QPalette::Base, QColor(23, 80, 127));
  palette.setColor(QPalette::AlternateBase, QColor(23, 80, 127));
...
void WhiteStyle::polish(QApplication *app) {
  if (!app) return;
  ...
  {
      // loadstylesheet
      QFile qfDarkstyle(QStringLiteral(":/windowStyle/whitetyle.qss"));
